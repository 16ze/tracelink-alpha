    ...
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      <div className="space-y-8">
        ...
        <div className="prose prose-slate max-w-none text-muted-foreground dark:prose-invert">
          ...
          <h2 className="text-xl font-semibold text-foreground mt-8 mb-4">3. Accès aux services</h2>
          <p className="mb-4">
            Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet.
          </p>

          <h2 className="text-xl font-semibold text-foreground mt-8 mb-4">4. Responsabilités</h2>
          <p className="mb-4">
