...
export function LoginForm({ locale }: { locale: string }) {
  ...
  // Créer des wrappers pour passer la locale
  const loginWithLocale = async (
    prevState: AuthActionState | null,
    formData: FormData
  ) => login(prevState, formData, locale);

  const signupWithLocale = async (
    prevState: AuthActionState | null,
    formData: FormData
  ) => signup(prevState, formData, locale);
